...
mass = numpy.loadtxt('/cosma5/data/durham/dc-murr1/star_average_stellar_mass.txt')
radius = numpy.loadtxt('/cosma5/data/durham/dc-murr1/star_average_stellar_radius.txt')
...
fig.savefig('/cosma5/data/durham/dc-murr1/star_spread_stellar_mass_metric_scatter.png')