...
gas_coords = numpy.loadtxt('/cosma5/data/durham/dc-murr1/gas_coords.txt')
...
d, i = tree.query(gas_coords, k = 10, n_jobs = -1)

numpy.savetxt('/cosma5/data/durham/dc-murr1/gas_stellar_nearest_halos.txt', i)