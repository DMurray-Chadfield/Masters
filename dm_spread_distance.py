...
hist.plot_hist(
    ...
    'Distance to nearest halo / halo radius',
    'Spread metric / halo radius',
    '/cosma5/data/durham/dc-murr1/dm_neighbour_spread_distance_0_25.png'
)
...
hist.plot_hist(
    ...
    'Distance to nearest halo / halo radius',
    'Spread metric / halo radius',
    '/cosma5/data/durham/dc-murr1/dm_neighbour_spread_distance_25_50.png'
)
...
hist.plot_hist(
    ...
    'Distance to nearest halo / halo radius',
    'Spread metric / halo radius',
    '/cosma5/data/durham/dc-murr1/dm_neighbour_spread_distance_50_75.png'
)
...
hist.plot_hist(
    ...
    'Distance to nearest halo / halo radius',
    'Spread metric / halo radius',
    '/cosma5/data/durham/dc-murr1/dm_neighbour_spread_distance_75_100.png'
)
'''