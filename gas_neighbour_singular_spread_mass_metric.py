...
mass = numpy.loadtxt('/cosma5/data/durham/dc-murr1/gas_neighbour_halo_mass.txt')
print(spread.shape, mass.shape)
...
ax.set_xlabel(r"Neighbour's nearest halo mass [$M_{\odot}$]")
fig.savefig('/cosma5/data/durham/dc-murr1/gas_neighbour_singular_spread_mass_metric.png')