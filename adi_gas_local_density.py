...
final_snap = SWIFTSnapshotData(
    filename = '/cosma6/data/dp004/dc-borr1/snap7/new_randomness_runs/adiabatic/Run_0/eagle_0007.hdf5',
...
numpy.savetxt('/cosma5/data/durham/dc-murr1/adi_gas_local_density.txt', nearby_particles)