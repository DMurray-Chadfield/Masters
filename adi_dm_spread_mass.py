...
hist.plot_hist(
    ...
    '/cosma5/data/durham/dc-murr1/adi_dm_spread_mass.png'
)
...
hist.plot_hist(
    ...
    r'Nearest halo mass [$M_{\odot}$]',
    'Spread metric / halo radius',
    '/cosma5/data/durham/dc-murr1/adi_dm_neighbour_spread_mass.png'
)
...
hist.plot_hist(
    ...
    r'Nearest halo mass [$M_{\odot}$]',
    'Spread metric / halo radius',
    '/cosma5/data/durham/dc-murr1/adi_dm_neighbour_spread_mass_0_25.png'
)
...
hist.plot_hist(
    ...
    r'Nearest halo mass [$M_{\odot}$]',
    'Spread metric / halo radius',
    '/cosma5/data/durham/dc-murr1/adi_dm_neighbour_spread_mass_25_50.png'
)
...
hist.plot_hist(
    ...
    r'Nearest halo mass [$M_{\odot}$]',
    'Spread metric / halo radius',
    '/cosma5/data/durham/dc-murr1/adi_dm_neighbour_spread_mass_50_75.png'
)
...
hist.plot_hist(
    ...
    r'Nearest halo mass [$M_{\odot}$]',
    'Spread metric / halo radius',
    '/cosma5/data/durham/dc-murr1/adi_dm_neighbour_spread_mass_75_100.png'
)