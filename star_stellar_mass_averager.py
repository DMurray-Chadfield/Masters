...
halos = numpy.loadtxt('/cosma5/data/durham/dc-murr1/star_stellar_nearest_halos.txt')
...
star_average_stellar_mass = find_average(halos, masses)
numpy.savetxt('/cosma5/data/durham/dc-murr1/star_average_stellar_mass.txt', star_average_stellar_mass)