...
mass = numpy.loadtxt('/cosma5/data/durham/dc-murr1/gas_average_halo_mass.txt')
radius = numpy.loadtxt('/cosma5/data/durham/dc-murr1/gas_average_halo_radius.txt')
...
fig.savefig('/cosma5/data/durham/dc-murr1/gas_spread_mass_metric_scatter.png')