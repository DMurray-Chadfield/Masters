...
rsimbaus = unyt.unyt_array(numpy.loadtxt('/cosma5/data/durham/dc-murr1/simba_gas_nearest_halo_radius.txt'), units = 'Mpc')
mass = unyt.unyt_array(numpy.loadtxt('/cosma5/data/durham/dc-murr1/simba_gas_nearest_halo_mass.txt'), units = 'msun')
density = unyt.unyt_array(numpy.loadtxt('/cosma5/data/durham/dc-murr1/simba_gas_local_density.txt'), units = 'dimensionless')
dm_halos = numpy.loadtxt('/cosma5/data/durham/dc-murr1/simba_gas_neighbour_halos.txt')
...
rsimbaus = rsimbaus[mask]
density = density[mask]

where = numpy.where(dm_halos >= 0)[0]
spread = spread[where]
mass = mass[where]
rsimbaus = rsimbaus[where]
...
hist.plot_hist(
    ...
    'Spread metric [Mpc]',
    '/cosma5/data/durham/dc-murr1/simba_gas_neighbour_spread_density.png'
)
'''
...
fig.savefig('/cosma5/data/durham/dc-murr1/simba_gas_compare_density.png')
'''