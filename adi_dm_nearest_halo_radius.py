...
halo_ids = numpy.loadtxt('/cosma5/data/durham/dc-murr1/adi_dm_nearest_halos.txt')
halo_ids = halo_ids.astype(int)

halo_radii = radii[halo_ids]

numpy.savetxt('/cosma5/data/durham/dc-murr1/adi_dm_nearest_halo_radius.txt', halo_radii)