...
radius = numpy.loadtxt('/cosma5/data/durham/dc-murr1/star_average_halo_radius.txt')
...
fig.savefig('/cosma5/data/durham/dc-murr1/star_spread_mass_metric_scatter.png')