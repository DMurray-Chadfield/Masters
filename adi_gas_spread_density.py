...
density = unyt.unyt_array(numpy.loadtxt('/cosma5/data/durham/dc-murr1/adi_gas_local_density.txt'), units = 'dimensionless')
...
fig.savefig('/cosma5/data/durham/dc-murr1/adi_gas_compare_density.png')