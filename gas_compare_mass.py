...
import gas_spread_mass
import simba_gas_spread_mass
from velociraptor import load

simba_spread = simba_gas_spread_mass.spread
simba_mass = simba_gas_spread_mass.mass
...
simba_radius = simba_gas_spread_mass.radius
simba_halo_centers, simba_halo_med, simba_halo_err = bml(simba_mass, simba_radius, x_bins = simba_bins)

eagle_spread = gas_spread_mass.spread
eagle_mass = gas_spread_mass.mass
...
eagle_radius = gas_spread_mass.radius
...
fig.savefig('/cosma5/data/durham/dc-murr1/gas_compare_mass.png')