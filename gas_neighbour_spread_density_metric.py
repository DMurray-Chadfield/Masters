...
density = numpy.loadtxt('/cosma5/data/durham/dc-murr1/gas_neighbour_density.txt')
...
fig.savefig('/cosma5/data/durham/dc-murr1/gas_neighbour_spread_density_metric.png')