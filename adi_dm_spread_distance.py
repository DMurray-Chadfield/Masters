...
spread = unyt.unyt_array(numpy.loadtxt('/cosma5/data/durham/dc-murr1/adiabatic_dm_spread.txt'), units = 'Mpc')
distance = unyt.unyt_array(numpy.loadtxt('/cosma5/data/durham/dc-murr1/adi_dm_nearest_halo_distance.txt'), units = 'Mpc')
radius = unyt.unyt_array(numpy.loadtxt('/cosma5/data/durham/dc-murr1/adi_dm_nearest_halo_radius.txt'), units = 'Mpc')
mass = unyt.unyt_array(numpy.loadtxt('/cosma5/data/durham/dc-murr1/adi_dm_nearest_halo_mass.txt'), units = 'msun')
dm_halos = numpy.loadtxt('/cosma5/data/durham/dc-murr1/adi_dm_neighbour_halos.txt')
...
hist.plot_hist(
    ...
    '/cosma5/data/durham/dc-murr1/adi_dm_spread_distance.png'
)
...
hist.plot_hist(
    ...
    'Distance to nearest halo / halo radius',
    'Spread metric / halo radius',
    '/cosma5/data/durham/dc-murr1/adi_dm_neighbour_spread_distance.png'
)
...
hist.plot_hist(
    ...
    'Distance to nearest halo / halo radius',
    'Spread metric / halo radius',
    '/cosma5/data/durham/dc-murr1/adi_dm_neighbour_spread_distance_0_25.png'
)
...
hist.plot_hist(
    ...
    'Distance to nearest halo / halo radius',
    'Spread metric / halo radius',
    '/cosma5/data/durham/dc-murr1/adi_dm_neighbour_spread_distance_25_50.png'
)
...
hist.plot_hist(
    ...
    'Distance to nearest halo / halo radius',
    'Spread metric / halo radius',
    '/cosma5/data/durham/dc-murr1/adi_dm_neighbour_spread_distance_50_75.png'
)
...
hist.plot_hist(
    ...
    'Distance to nearest halo / halo radius',
    'Spread metric / halo radius',
    '/cosma5/data/durham/dc-murr1/adi_dm_neighbour_spread_distance_75_100.png'
)