...
halos = numpy.loadtxt('/cosma5/data/durham/dc-murr1/star_nearest_halos.txt')
...
numpy.savetxt('/cosma5/data/durham/dc-murr1/star_average_halo_mass.txt', average_halo_mass)